...
const headers = [
    ...
    { title: '회의구분', align: 'center', key: 'mtngTypeCd', sortable: false }, //회의구분코드?
    { title: '제목', align: 'center', key: 'mtngSj', sortable: false },
    { title: '위원회', align: 'center', key: 'cmtNm', sortable: false },
    { title: '회의일시', align: 'center', key: 'openDtm', sortable: false },
    { title: '산회일시', align: 'center', key: 'closeDtm', sortable: false },
];
...
const fnGoDetail = (e, row) => {
    router.push({ name: 'mtngDetail', params: { id: row.item.mtngId } });
}

const fnGoSave = (e, row) => {
    router.push({ name: 'MtngSave' });
}
...
<template>
    ...
    <v-container class="lg-12">
        ...
        <v-row class="lg-12">
            ...
            <v-col>
                <v-card>
                    <v-card-title>■ 컨퍼런스 회의 등록</v-card-title>
        ...
        <v-row class="lg-12">
            ...
            <v-col align="end">
                <v-btn @click="fnGoSave" color="primary">회의등록</v-btn>
            </v-col>
            <v-col cols="1"></v-col>
        </v-row>
